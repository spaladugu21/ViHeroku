...
if(!empty($xmlarray) && $xmlarray!=='no_record'){
    foreach ($xmlarray as $key=>$val){
		...
		$hdate = "'" .date("Y-m-d h:i:sa T"). "'";
			...
			$Container_Asset_SerialNumber_c =$fdata['Notification']['sObject']['Container_Asset_SerialNumber_c'];
                $Container_Asset_SerialNumber_c = !empty($fdata['Notification']['sObject']['Container_Asset_SerialNumber_c']) ? "'$Container_Asset_SerialNumber_c'" : "NULL";
